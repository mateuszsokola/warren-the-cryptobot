...
def create_exchanges_with_routes(
    web3: Web3, async_web3: Web3, network: Network = Network.Ethereum
) -> dict[str, List[BaseTokenPair]]:
    exchanges = {
...
def get_token_routes(web3: Web3, network: Network = Network.Ethereum) -> dict[BaseToken, List[BaseToken]]:
    exchanges = {
        Network.Ethereum.value: [
            # uniswap_v3_quoter
            # UniswapV3Exchange(
...
def get_exchanges_by_token_pair(
    web3: Web3, async_web3: Web3, token0: BaseToken, token1: BaseToken, network: Network = Network.Ethereum
) -> List[BaseTokenPair]:
    exchanges = {
        Network.Ethereum.value: [
            # uniswap_v3_quoter
