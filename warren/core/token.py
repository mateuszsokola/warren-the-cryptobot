...
class Token:
    ...
    def __init__(self, web3: Web3, async_web3: Web3, network: Network = Network.Ethereum, filename: str = "./tokens.yml"):
        self.async_web3 = async_web3
        self.web3 = web3

        self._token_map = self._load_tokens(filename=filename, network=network)
    ...
    def _load_tokens(self, filename: str, network: Network = Network.Ethereum):
        ...
        for meta in file_content[network.value.lower()]:
            name = meta["name"]
